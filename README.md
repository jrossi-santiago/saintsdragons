...
- `7stories/` — the email-gated campaign page served at `/7stories`:
  ...
  - `stories.js` — form validation and reveal. The `submit` handler has a marked spot for POSTing the signup to your email platform.
...
- **Campaign page** — all visible copy in `7stories/index.html` is sample text. The form fields are first name, last name, children's age ranges (multi-select: 0–2, 3–5, 6–9, 10+) and email; all are required.
